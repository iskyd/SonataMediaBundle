    ...
    public function createAction(Request $request = null)
    {
        ...
        if (!$request->get('provider') && $request->isMethod('get')) {
            return $this->render('SonataMediaBundle:MediaAdmin:select_provider.html.twig', array(
                'providers' => $this->get('sonata.media.pool')->getProvidersByContext($this->get('request_stack')->getCurrentRequest()->get('context', $this->get('sonata.media.pool')->getDefaultContext())),
